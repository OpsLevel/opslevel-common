...
This document is a guide intended for folks interested in contributing to `opslevel-common`. Below, we document the process by which members of the community should create issues and submit pull requests (PRs) in this repository. This guide assumes you are using macOS and are comfortable with the command line.
